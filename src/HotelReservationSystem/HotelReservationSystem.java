...
public class HotelReservationSystem {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException{
        ...
        try{
            ...
            System.err.println("Failed to established the connect!!! :- " + e.getMessage());
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        }
    }

    /* Load driver function is for to load the sql driver */
    ...
    /* Reserve the room. Add new data into the table*/
    ...
    private static void  getRoomNumber(Connection connection, Scanner scanner){
        try {
            ...
            String sqlQuery = "SELECT room_number FROM reservations " +
    ...
    public static void exit() throws InterruptedException {
        ...
        System.out.println();
        System.out.println("Thank you for using Hotel Reservation Sytem!!!!");
    }
}
